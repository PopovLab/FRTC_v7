# FRTC code Workspace v7 for [Astra-Box](https://github.com/temper8/Astra-Box)

[Documentation](https://popovlab.github.io/FRTC_DOC/)

v7

- Исправление проблем с ограниченим по nr. 
- сохранение равновесия плазмы в формате nml
- добавил параметр save interval - определяет интервал между сохранениями траекторий и распределений

v6 

- новая структура папок c разделением спектров и настроек frts
